...
$services_query = "SELECT * FROM service_types ORDER BY id ASC LIMIT 5";
$services_result = mysqli_query($conn, $services_query);
?>


<?php if(isset($_SESSION['user_id'])): ?>
    <a href="<?php echo $_SESSION['role'] == 'admin' ? 'admin_dashboard.php' : 'user_dashboard.php'; ?>" class="btn btn-primary">
        <span class="span">My Dashboard</span>
    </a>
<?php else: ?>
      ...
      <section class="section service has-bg-image" aria-labelledby="service-label"
        ...
        <ul class="service-list">
                    ...
                    while($service = mysqli_fetch_assoc($services_result)): 
                        // Skip image 5 for the cards, because 5 is the big red car banner!
                        $img_num = ($i == 5) ? 6 : $i; 
                    ?>
                    ...
                    <li>
                      <div class="service-card">
                        <figure class="card-icon">
                          <img src="./assets/images/services-<?php echo $img_num; ?>.png" width="110" height="110" loading="lazy" alt="<?php echo $service['name']; ?>">
                        </figure>

                        <h3 class="h3 card-title"><?php echo $service['name']; ?></h3>

                        <p class="card-text">
                          Starting at <strong>$<?php echo number_format($service['price'], 2); ?></strong>
                        </p>

                        <a href="user_dashboard.php" class="btn-link">Book Now</a>
                      </div>
                    </li>
          ...
          <a href="#" id="viewAllBtn" class="btn">
